...
angular.module('handyforall.site', [
    ...
    .provider("routes", function routeProvider() {
        ...
        function restAPIs() {
            return ({
                ...
                "walletRechargePayfast": { method: 'POST', url: "/site/account/walletPayfastPayment" },
    ...
    .controller('MainCtrl', function ($scope, $location, $rootScope, $http, toastr, MainserviceResolve, MainService, $state, $translate, $cookieStore, swal, AuthenticationService, $cookieStore, ngMeta, $sce) {
        ...
        mac.banner_video = $sce.trustAsResourceUrl(mac.banner[0].video + '?playlist=8eJ2u5o7Jns&start=60&rel=0&autoplay=1&controls=0&showinfo=0&loop=1&iv_load_policy=3&enablejsapi=1');
