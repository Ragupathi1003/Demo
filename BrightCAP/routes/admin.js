...
module.exports = function (app, io) {
    try {
        ...
        app.post('/tasker/active-document-lists', ensureAuthorized, taskers.activeDocumentLists);
        ...
        app.post('/admin/tasker/update-documents', ensureAuthorized, taskers.updateDocuments)
