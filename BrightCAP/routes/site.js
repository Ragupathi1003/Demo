...
module.exports = function (app, io) {
    try {
		...
		app.post('/site/tasker/taskerDocumentAdd', ensureAuthorized, middlewares.commonUpload(CONFIG.DIRECTORY_OTHERS_TASKER).any(), siteUsers.taskerDocumentAdd)
		app.post('/site/tasker/taskerDocumentEdit', ensureAuthorized, middlewares.commonUpload(CONFIG.DIRECTORY_OTHERS_TASKER).any(), siteUsers.taskerDocumentEdit);
		app.post('/site/tasker/update-documents', ensureAuthorized, siteUsers.updateDocuments)
        /* Slider page*/
        ...
        app.post('/site/account/payfastPayment', ensureAuthorized, account.payfastPayment);
        app.post('/site/account/payfastExecute',account.payfastExecute);
        app.get('/site/account/payfastSuccess',account.payfastSuccess);
        app.get('/site/account/payfastCancel',account.payfastCancel);

        app.post('/site/account/walletPayfastPayment', ensureAuthorized, account.walletPayfastPayment);
        app.post('/site/account/walletPayfastExecute', account.walletPayfastExecute);
        app.get('/site/account/walletPayfastSuccess', account.walletPayfastSuccess);
        app.get('/site/account/walletPayfastCancel', account.walletPayfastCancel);
        //--payfast//------------------
        ...
        //Common api //------------05-06-2020
        app.post('/site/common/payfastdatainsert', common.payfastinsert);
    } catch (e) {
